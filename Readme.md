...
The generator supports string text, number, integer, boolean, date, and datetime fields. It leaves media, relations, rich text, and unsupported custom field types unchanged. The plugin never creates or submits a content object itself.
>>>>>>> Stashed changes
